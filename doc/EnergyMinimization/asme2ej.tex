...
\begin{align}
 ...
 \frac{d}{db} \int_0^b
  \left\{
    \begin{array}{lr}
      r \cdot c(r) dr , & \text{if } -1/2 < r < 1/2 \\
...
\begin{align}
  ...
  \left\{
  \begin{array}{lr}
    b \cdot c'(b) + c(b), & \text{if } 0 \leq b < 1/2 \\
