...
non-magnetic fluid.\footnote{Joe Herschberge has aptly
  ...
  force on a cohering mass of less-susceptible material immersed in
  more-susceptible ferrofluid in the direction opposite to
  the field gradient.} This occurs at $a = 0$, so $A(b) = 0$, or $b = \sqrt{\frac{2S}{\pi}}$ by Equation~\ref{eq:maximalB}.
