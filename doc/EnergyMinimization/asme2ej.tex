...
NOTE: Now I am out of steam. I suppose that we can do this
differentiation if we choose $S$ and $k$, and then we will
have a polynomial in $b$, which we can solve to get a $b$ value. But the piecewise nature makes it a bit complicated. I
will be simplified after we choose $S$.
